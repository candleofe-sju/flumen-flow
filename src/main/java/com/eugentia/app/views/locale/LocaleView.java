package com.eugentia.app.views.locale;

import com.eugentia.app.data.service.GreetService;
import com.eugentia.app.listeners.ServiceInitListener;
import com.eugentia.app.provider.SimpleI18NProvider;
...
/**
 * An application that demonstrates the configuration and usage of Vaadin's
 ...
 * whenever a user navigates to our app.
 * <p>
...
@RolesAllowed("USER")
public class LocaleView extends VerticalLayout implements LocaleChangeObserver {
    ...
    public LocaleView(@Autowired GreetService service, @Autowired I18NProvider i18NProvider) {
        addClassNames("locale-view");
